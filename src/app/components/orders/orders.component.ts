...
export class OrdersComponent {
  ...
  constructor(private http: HttpService, private swal: SwalService,private date:DatePipe) {
  ...
  deleteById(model:OrderModel){
    ...
    this.swal.callSwal('Sipariş Sil?',`${model.customer.name} - ${model.number} numaralı siparişi silmek istiyor musunuz?`,()=>{
